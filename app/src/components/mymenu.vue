	...
	<div>
		<b-modal ref="menu" hide-header hide-footer>
			<form>
				...
				<b-button variant="outline-primary" block v-b-modal.withdraw>Withdraw</b-button>
		...
		<b-modal ref="withdraw" id="withdraw" title="Withdraw" hide-footer>
			<b-form>
				<b-form-group>
					<label for="balance" style="color:grey; font-size:24px">Withdrawable</label>
					<p style="font-size:24px; margin-top:5px">₹ {{me?Number(me.balance).toFixed(2): '-'}}</p>
				</b-form-group>
				<b-form-group>
					<p style="font-size:20px; color:#147239;">Withdraw via <img style="height:20px" src="../assets/paytm.png"></p>
					<p class="pl-3" style="font-size:20px; color:#147239;" v-if="me.paytm_id">{{me.paytm_id}}</p>
					<b-button v-else size="lg" variant="outline-primary" v-b-modal.paytmid>+ Add Paytm ID</b-button>
				</b-form-group>
				<b-form-group label="Select amount:(₹500-₹50000)" class="mt-1">
					...
					<b-form-invalid-feedback id="input-amount-live-feedback">The amount must be between 500 and 50,000 and be divisible by 100</b-form-invalid-feedback>
				</b-form-group>
				<ol>
					<li>The cash withdrawal amout must be at least ₹500.</li>
					<li>Daily cash withdrawal limit of ₹50000.</li>
					<li>The amount entered must be an integral multiple of ₹100.</li>
					<li>The service charge shall be deducetd by payment channel :5%.</li>
				</ol>
				<b-form-group>
		...
		<b-modal ref="paytmid" id="paytmid" title="Add Paytm ID" hide-footer>
			<b-form>
				<b-form-group>
					...
					<b-form-invalid-feedback id="input-phone-live-feedback">This is a required field must be 10 numerics starts with 7, 8, or 9</b-form-invalid-feedback>
				</b-form-group>
			<b-form-group class="mt-5">
				<b-button block variant="primary" v-on:click="setpaytmid">Save</b-button>
			</b-form-group>
			</b-form>
		</b-modal>
	</div>
