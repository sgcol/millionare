...
const createOrder=exports.createOrder=async function(orderid, money, req, cb) {
...
const createWithdraw=exports.createWithdraw=async function(orderid, money, phone, req, cb) {
    cb=cb||function (err, r){
        if (err) throw err;
        return r;
    }
